...
class DataGenerator {
    ...
    -static void generateDepartments()
    -static void generateEmployees()
    -static void generateLeaveBalances()
    -static void generateAttendanceRecords()
    -static void generateLeaveRequests()
    -static void generatePayrollEntries()
    -static void generatePayrollRuns()
}
